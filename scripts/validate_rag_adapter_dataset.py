...
def parse_args():
    ...
    parser.add_argument("--root_dir", default="data/rag_zero123plus_tiny")
...
def main():
    ...
    dataset = ManifestRAGZero123PlusData(root_dir=str(root), manifest_fname=args.manifest, validation=False)
    sample = dataset[0]
