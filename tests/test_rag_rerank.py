...
from src.utils.rag_rerank import generate_zero123plus_candidate, split_zero123plus_sheet
...
class RagRerankTest(unittest.TestCase):
    ...
    def test_candidate_generation_does_not_pass_references_to_zero123plus(self):
        ...
        self.assertNotIn("rag_refs", kwargs)
        self.assertNotIn("rag_mode", kwargs)
